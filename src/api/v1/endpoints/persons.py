...
async def search_persons(
    ...
    Пример: `GET /api/v1/persons/search?sort=full_name:desc`.
    """
...
# TODO Доделать список фильмов персоны
# @router.get("/{uuid}/film", response_model=FilmList, summary="Фильмы персоны")
# async def get_person_films(uuid: UUID, ...):
